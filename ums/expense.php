...
mysqli_query($conn,"INSERT into livestock_animal_expense(expense_id,expense_type,expense_date,animal_id,expense,expstrt,expend,nar) values('$pid','$prid','$pdate','$animalid','$expense','$expstrt','$expend','$nar')") or die(mysqli_error($conn));
$_SESSION['success']='Expense done';
header("location:expense-listing.php");
die();
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <div class="alert alert-success in alert-dismissible" style="margin-top:18px;">
                                    ...
                                    <strong>Success!</strong> The Expense Is Submitted.
                                </div>
                                    <?php
                                }
                                ...
                                <h1 class="h4 text-gray-900 mb-4">Livestock Expense</h1>
                            </div>
                            <form class="user" method="post" action="" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';" >
                                <?php 
                                $result = mysqli_query($conn,"select concat(lpad(ifnull(max(substring(expense_id,1,6)),0)+1,6,0),'E') as 'ID' from livestock_animal_expense") or die(mysqli_error($conn));
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <?php
                                        $query2 = mysqli_query($conn,"SELECT tag_code from livestock_animal where id_pk='".$_GET['id']."'") or die(mysqli_error($conn));
                                            $row2 = mysqli_fetch_array($query2);
                                        ?>
                                        <label>Animal ID*</label>
                                        <input type="text" readonly class="form-control" value="<?=$row2['tag_code']?>">
                                </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control js-example-basic-single" name="prid" id='ven'>
                                            ...
                                            <?php
                                            $result = mysqli_query($conn,"SELECT * from livestock_expense_type") or die(mysqli_error($conn));
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="date" step="any" class="form-control" name="expstrt" 
                                            placeholder="RMB" required value="<?=date("Y-m-d");?>"> 
                                    </div>
                                    <div class="col-sm-2">
                                        <label>Range End</label>
                                        <input type="date" step="any" class="form-control" name="expend" 
                                            placeholder="RMB" required value="<?=date("Y-m-d");?>"> 
                                    </div>
                                </div>
