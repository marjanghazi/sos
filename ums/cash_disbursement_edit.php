...
if (isset($_POST['update_summary'])) {
    ...
    if ($stmt->execute()) {
        ...
        $message = "Error updating cash disbursement summary: " . $stmt->error;
        $message_type = "error";
    }
    $stmt->close();
}
...
<head>
    ...
    <title>Edit Cash Disbursement Summary - GUARDING DASHBOARD</title>
    <!-- Favicon icon -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Cash Disbursement Summary</h1>
                    ...
                    <div class="card form-card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="cash_disbursement_edit.php?id=<?php echo $summary_id; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="transaction_date" name="transaction_date" 
                                                   value="<?php echo date('Y-m-d\TH:i', strtotime($summary['transaction_date'])); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="city_id" name="city_id" required>
                                                ...
                                                while($city = $cities_result->fetch_assoc()): 
                                                    $selected = ($city['city_id'] == $summary['city_id']) ? 'selected' : '';
                                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="camp_site_id" name="camp_site_id" required>
                                                ...
                                                while($camp_site = $camp_sites_result->fetch_assoc()): 
                                                    $selected = ($camp_site['camp_site_id'] == $summary['camp_site_id']) ? 'selected' : '';
                                                ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="setup_fee_applied" name="setup_fee_applied" required>
                                                ...
                                                <option value="Yes" <?php echo ($summary['setup_fee_applied'] == 'Yes') ? 'selected' : ''; ?>>Yes</option>
                                                <option value="No" <?php echo ($summary['setup_fee_applied'] == 'No') ? 'selected' : ''; ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="setup_fee_type" name="setup_fee_type">
                                                ...
                                                <option value="Fixed" <?php echo ($summary['setup_fee_type'] == 'Fixed') ? 'selected' : ''; ?>>Fixed</option>
                                                <option value="Percentage" <?php echo ($summary['setup_fee_type'] == 'Percentage') ? 'selected' : ''; ?>>Percentage</option>
                                                <option value="Variable" <?php echo ($summary['setup_fee_type'] == 'Variable') ? 'selected' : ''; ?>>Variable</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="total_transactions" name="total_transactions" 
                                                   value="<?php echo $summary['total_transactions']; ?>" min="0" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="total_amount" name="total_amount" 
                                                   value="<?php echo $summary['total_amount']; ?>" min="0" step="0.01" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" name="update_summary" class="btn btn-primary btn-lg">
